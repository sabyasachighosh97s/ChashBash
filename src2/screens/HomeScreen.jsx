...
import { CustomSubCard } from '@components/cards/CustomSubCard';
  ...
  */
  ...
  return (
    <Container scrollable>
      ...
      <BackgroundImage source={require('../assets/images/weather.png')}>
        ...
        <View style={styles.weatherGlassCard}>
          ...
          <View style={styles.weatherMainRow}>
            ...
            <View>
              <Text style={styles.temperature}>{selectedForecast.temp}</Text>
            </View>

            {/* RIGHT */}

            <View style={styles.weatherRight}>
              <Paragraph style={styles.weatherCloud}>
              ...
              <Paragraph style={styles.weatherDate}>{t('weather_date')}</Paragraph>
            </View>
          </View>
          ...
          <View style={styles.weatherDetailsRow}>
            <View style={styles.weatherItem}>
              <Paragraph style={styles.weatherItemLabel}>{t('humidity')}</Paragraph>
              <Paragraph style={styles.weatherItemValue}>85%</Paragraph>
            </View>
            <View style={styles.weatherDivider} />
            <View style={styles.weatherItem}>
              <Paragraph style={styles.weatherItemLabel}>{t('precipitation')}</Paragraph>
              <Paragraph style={styles.weatherItemValue}>8 mm</Paragraph>
            </View>
            <View style={styles.weatherDivider} />
            <View style={styles.weatherItem}>
              <Paragraph style={styles.weatherItemLabel}>{t('wind_speed')}</Paragraph>
              <Paragraph style={styles.weatherItemValue}>13 km/h</Paragraph>
            </View>
          </View>
      ...
      <CustomCard style={styles.dynamicCard}>
        <Headline>{selectedModule.data.title}</Headline>
        <Paragraph style={styles.dynamicDescription}>{selectedModule.data.description}</Paragraph>
        {/* CARBON */}
  ...
  <View style={styles.carbonCardsRow}>
    ...
    <CustomSubCard
      variant="blue"
      style={styles.awdCard}
    >
      <Paragraph style={styles.carbonCardTitle}>
        AWD পদ্ধতি
      </Paragraph>

      <View style={styles.priceBoxBlue}>
        <Paragraph style={styles.incomeLabel}>
          আয় করতে পারবেন
        </Paragraph>

        <Paragraph style={styles.priceBlue}>
          ₹ 3,200
        </Paragraph>
      ...
      <TouchableOpacity
        style={styles.detailsButtonBlue}
      >
        <Paragraph style={styles.detailsTextBlue}>
          বিস্তারিত দেখুন →
        </Paragraph>
      </TouchableOpacity>
    </CustomSubCard>
    ...
    <CustomSubCard
      ...
      style={styles.awdCard}
    >
      <Paragraph style={styles.biocharTitle}>
        Biochar পদ্ধতি
      </Paragraph>
      ...
      <View style={styles.priceBoxGreen}>
        ...
        <Paragraph style={styles.priceGreen}>
          ₹ 4,800
        </Paragraph>
      ...
      <TouchableOpacity
        style={styles.detailsButtonGreen}
      >
        <Paragraph style={styles.detailsTextGreen}>
          বিস্তারিত দেখুন →
        </Paragraph>
      </TouchableOpacity>
    </CustomSubCard>
